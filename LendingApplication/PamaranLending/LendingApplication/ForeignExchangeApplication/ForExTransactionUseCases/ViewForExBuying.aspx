<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewForExBuying.aspx.cs" Inherits="LendingApplication.ForeignExchangeApplication.ForExTransactionUseCases.ViewForExBuying" %>
                                        ...
                                        <ext:CompositeField ID="CompositeField5" runat="server" AnchorHorizontal="98%">
                                            <Items>
                                                <ext:TextField ID="txtReceivedAmount" runat="server" FieldLabel="Amount Received" 
                                                    ReadOnly="true" Flex="1" EnableKeyEvents="true">
                                                </ext:TextField>
                                    ...
                                    <Items>
                                        <ext:CompositeField ID="CompositeField2" runat="server" AnchorHorizontal="98%">
                                            <Items>
                                                ...
                                                <ext:TextField ID="txtConvertedAmountCurrency" runat="server" ReadOnly="true" Width="55" />
                                            </Items>
                                        </ext:CompositeField>
