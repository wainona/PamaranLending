...
{
    public partial class AddForExSelling : ActivityPageBase
    {
        ...
        protected void btnSave_Click(object sender, DirectEventArgs e)
        {
            ...
            form.AmountReleased = decimal.Parse(txtAmountToBuy.Text);
        ...
        private void ConvertOriginal(decimal originalAmount)
        {
            ...
            txtAmountToBuy.Text = converted.ToString("N");
        }
        ...
        public void FillExchangeRateField()
        {
            ...
            txtAmountToBuyCurrency.Text = exRate.Currency.Symbol;
            txtAmountCashDetailCurrency.Text = exRate.Currency.Symbol;
            txtAmountCheckDetailCurrency.Text = exRate.Currency.Symbol;

            txtReceivedAmountCurrency.Text = exRate.Currency1.Symbol;
            hdnReceivedCurrencyId.Value = exRate.Currency1.Id;
            hdnReleasedCurrencyId.Value = exRate.Currency.Id;
        }
