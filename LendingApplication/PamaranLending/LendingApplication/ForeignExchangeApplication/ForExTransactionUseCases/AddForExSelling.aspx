<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddForExSelling.aspx.cs" Inherits="LendingApplication.ForeignExchangeApplication.ForExTransactionUseCases.AddForExSelling" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var convert = function () {
            ...
            var originalAmount = 1 * txtAmountToBuy.getValue().replace(',', '');
            var convertedAmount = originalAmount * rate;

            txtReceivedAmount.setValue(Ext.util.Format.number(convertedAmount, '0,0.00'));
        };
        ...
        var clearExchangeRate = function () {
            ...
            txtAmountToBuyCurrency.setValue('');
        ...
        var onFormValidated = function (valid) {
            btnSave.disable();
            var total = txtAmountToBuy.getValue();
                                        ...
                                        <ext:CompositeField ID="CompositeField1" runat="server" AnchorHorizontal="95%">
                                            <Items>
                                                ...
                                                <ext:Button ID="btnPickExchangeRate" runat="server" Text="" Icon="Magnifier">
                                                    <Listeners>
                                                        <Click Handler="window.proxy.requestNewTab('PickExchangeRate', '/ForeignExchangeApplication/ExchangeRateUseCases/PickListExchangeRate.aspx?ratetype=Selling', 'Pick Exchange Rate');" />
                                                    </Listeners>
                                                </ext:Button>
                                ...
                                <ext:Panel ID="AmountReleasedPanel" runat="server" Title="Release" Padding="10"
                                    ...
                                    <Items>
                                        <ext:CompositeField ID="CompositeField2" runat="server" AnchorHorizontal="98%">
                                            <Items>
                                                <ext:TextField ID="txtAmountToBuy" runat="server" FieldLabel="Amount to Buy" ReadOnly="false"
                                                    ...
                                                    <Listeners>
                                                        ...
                                                        <KeyUp Handler="amountToBuyChange(); convert();" />
                                                    </Listeners>
                                                </ext:TextField>
