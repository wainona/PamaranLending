<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddForExTransaction.aspx.cs" Inherits="LendingApplication.ForeignExchangeApplication.ForExTransactionUseCases.AddForExTransaction" %>
                    ...
                    <Items>
                        <ext:TabPanel runat="server" Padding="5" Border="false">
                            <Items>
                                <ext:Panel Title="Amount Received" runat="server">
                                    <Items>
                                        ...
                                        <ext:CompositeField runat="server">
                                            <Items>
                                                ...
                                                <ext:Button ID="btnPickExchangeRate" runat="server" Text="" Icon="Magnifier">
                                                    <Listeners>
                                                        <Click Handler="window.proxy.requestNewTab('PickExchangeRate', '/ForeignExchangeApplication/ExchangeRateUseCases/PickListExchangeRate.aspx?ratetype=None', 'Pick Exchange Rate');" />
                                                    </Listeners>
                                                </ext:Button>
                                        ...
                                        <ext:CompositeField runat="server">
                                            <Items>
                                                <%-- Original Amount --%>
                                                <ext:TextField ID="txtAmountReceived" runat="server" FieldLabel="Amount Received" Width="275" AllowBlank="false" EnableKeyEvents="true" MaskRe="[0-9\.\,]">
                                                    <Listeners>
                                ...
                                <ext:Panel Title="Amount Released" runat="server" Border="false" AutoScroll="true">
                                    <Items>
