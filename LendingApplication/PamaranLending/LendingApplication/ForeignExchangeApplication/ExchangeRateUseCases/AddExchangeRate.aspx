<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddExchangeRate.aspx.cs" Inherits="LendingApplication.ForeignExchangeApplication.ExchangeRateUseCases.AddExchangeRate" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var addSuccess = function () {
            showAlert('Success!', 'Successfully added an exchange rate record.', function () {
                window.proxy.sendToAll('addexchangerate', 'addexchangerate');
                window.proxy.requestClose();
            });
        }
    </script>
        ...
        <ext:Viewport ID="PageViewPort" runat="server" Layout="Fit">
            <Items>
                <ext:FormPanel ID="PageFormPanel" runat="server" Border="false" Padding="5" MonitorValid="true" LabelWidth="150">
                    ...
                    <Items>
                        <ext:ComboBox ID="cmbCurrencyFrom" runat="server" FieldLabel="Currency From" Width="350" Editable="false" DisplayField="NameDescription" ValueField="Id" AllowBlank="false">
                            <Store>
                        ...
                        <ext:ComboBox ID="cmbCurrencyTo" runat="server" FieldLabel="Currency To" Width="350" Editable="false" DisplayField="NameDescription" ValueField="Id" AllowBlank="false">
                            <Store>
                        ...
                        <ext:ComboBox ID="cmbExchangeRateType" runat="server" DisplayField="Name" ValueField="Id" Editable="false" AllowBlank="false" Width="350" FieldLabel="Type">
                            <Store>
                        ...
                        <ext:TextField ID="txtRate" runat="server" FieldLabel="Rate" AllowBlank="false" Width="350" MaskRe="[0-9\.\,]" />
                    </Items>
                    <BottomBar>
