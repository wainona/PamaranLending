<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgingSummaryInBalances.aspx.cs" Inherits="LendingApplication.Applications.AgingOfAccountsUseCases.AgingSummaryInBalances" %>
...
<head runat="server">
    <title>Aging of Accounts Summary In Balances</title>
    ...
    <div id="PrintableContent">
        <table style="width:800px; margin: 0 auto;">
                ...
                <tr class="nameOfDocument">
                    <td style="text-align:center; vertical-align:bottom; font-weight:bold; border-bottom-color: Gray; border-bottom-width:thin; text-transform:uppercase;" class="style3" colspan="7">
                        <br />
                        AGING 
                        of Accounts SUMMARY AS OF
                        <ext:Label ID="lblSelectedDate" runat="server" />
                        <p style="text-transform:capitalize;">In Balances</p>
                        <br />
                        <br />
                        <br />
                    </td>
                    ...
                    <td colspan="7">
                        <table border="1" cellpadding="10" cellspacing="0" width="950" >
                            ...
                            <tr style="height: 35px">
                               <td align="center" width="120">In Amount</td>
                               <td align="center" >
                                    <ext:Label runat="server" ID="lblAmountTotal" />
                               </td>
                               <td align="center" >
                                    <ext:Label runat="server" ID="lblAmountCurrent" />
                               </td>
                               <td align="center" >
                                    <ext:Label runat="server" ID="lblAmount130" />
                               </td>
                               <td align="center" >
                                    <ext:Label runat="server" ID="lblAmount3160" />
                               </td>
                               <td align="center" >
                                    <ext:Label runat="server" ID="lblAmount6190" />
                               </td>
                               <td align="center" >
                                    <ext:Label runat="server" ID="lblAmountOver90" />
                               </td>
                            </tr>
                            <tr style="height: 35px">
