<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddRediscounting.aspx.cs"
    Inherits="LendingApplication.Applications.DisbursementUseCases.AddRediscounting" %>
    ...
    <script type="text/javascript">
        ...
        var saveSuccessful = function () {
            ...
            showAlert('Status', 'Successfully added the record.', function () {
                window.proxy.sendToAll(data, 'addrediscounting');
            });
        };
        ...
        var onAddCheque = function () {
            ...
            window.proxy.requestNewTab('AddRediscountingCheque', param, 'Add Cheque');
        }
                    ...
                    <ext:TabPanel ID="TabPanel" runat="server" Padding="0" Border="false" EnableTabScroll="true"
                        ...
                        <Items>
                                    ...
                                    <ext:Panel ID="Panel2" runat="server" ColumnWidth=".6" Layout="FormLayout" Border="false"
                                        ...
                                        <Items>
                                            ...
                                            <ext:DateField ID="txtTransactionDate" FieldLabel="Transaction Date" Editable="false"
                                                AllowBlank="false" runat="server" AnchorHorizontal="60%" Vtype="daterange" EndDateField="txtChkDate">
                                            </ext:DateField>
                                            ...
                                            <ext:DateField ID="txtChkDate" Editable="false" FieldLabel="Check Date" AllowBlank="false"
                                                runat="server" AnchorHorizontal="60%"  Vtype="daterange">
                                            </ext:DateField>
                            ...
                            <ext:Panel ID="Panel1" runat="server" Layout="FormLayout" Title="Disbursement Details"
                                LabelWidth="200" ColumnWidth=".6" RowHeight=".5" Padding="5" Border="false">
                                <Items>
                                    ...
                                    <ext:Panel ID="PanelForPayCheck" AutoHeight="true" AnchorHorizontal="95%" runat="server"
                                        ...
                                        <Items>
                                            ...
                                            <ext:GridPanel ID="gridPanelChecks" runat="server" Height="230" EnableColumnHide="false"
                                                ...
                                                <ColumnModel ID="columnModelChecks" runat="server" Width="100%">
                                                    <Columns>
