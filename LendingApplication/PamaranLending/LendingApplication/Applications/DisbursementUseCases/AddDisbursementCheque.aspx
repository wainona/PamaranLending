<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDisbursementCheque.aspx.cs" Inherits="LendingApplication.Applications.DisbursementUseCases.AddDisbursementCheque" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var AddCheque = function () {
            var data = {};
            data.BankPartyRoleId = hiddenBankID.getValue();
                ...
                <Items>
                    <ext:Panel ID="PanelAddCheques" runat="server" Layout="ColumnLayout"  Height="400" Border="false">
                        <Items>
                            ...
                            <ext:Hidden ID="hiddenBankID" runat="server"></ext:Hidden>
                            <ext:Hidden ID="hdnChequeValid" runat="server" ></ext:Hidden>
                            <ext:Hidden ID="hiddenRandomKey" runat="server" />
                            <ext:Hidden ID="hdnType" runat="server"></ext:Hidden>
                            <ext:Panel ID="PanelDetails" runat="server" ColumnWidth=".5" LabelWidth="100" Height="400" Layout="FormLayout" Border="false">
                                <Items>
