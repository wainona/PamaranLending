<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintEncashment.aspx.cs" Inherits="LendingApplication.Applications.DisbursementUseCases.PrintEncashment" %>
                    ...
                    <td>
                        <ext:GridPanel ID="grdBreakdown" runat="server" AutoHeight="true" Width="560"  EnableColumnHide="false" ColumnLines="true" BaseCls="cssClass">
                            ...
                            <ColumnModel ID="GridPanelPaymentColumnModel" runat="server">
                                <Columns>
                                    <ext:Column Header="Payment Method" Locked="true" MenuDisabled="true"
                                        Sortable="false"  Hideable="false" DataIndex="PaymentMethod"
                                        Align="Center" Fixed="true" Resizable="false" Width="90"
                                        Css="border-color: Black;" />
                                    <ext:Column Header="Bank Name" Locked="true" MenuDisabled="true"
                                        Sortable="false"  Hideable="false" DataIndex="BankName"
                                        Align="Center" Css="border-color: Black;" Width="130" />
                                    <ext:Column Header="Branch" Locked="true" MenuDisabled="true"
                                        Sortable="false"  Hideable="false" DataIndex="BankBranch"
                                        Align="Center" Css="border-color: Black;" Width="120" />
                                    <ext:Column Header="Check Number" Locked="true" MenuDisabled="true"
                                        Sortable="false" Hideable="false" DataIndex="CheckNumber"
                                        Align="Center" Css="border-color: Black;" Width="100"/>
                                    <ext:NumberColumn Header="Amount" Locked="true" MenuDisabled="true"
                                        Sortable="false" Hideable="false" DataIndex="TotalAmount"
                                        Align="Center" Css="border-color: Black;" Width="110" Format=",000.00" />
                                </Columns>
                            </ColumnModel>
                        </ext:GridPanel>
                    </td>
                    ...
                    <td class="style7">
                        <table>
                            <tr>
                                ...
                                <td class="style5">
                                    <center>
                                        <ext:Image ID="imgSignature" Hidden="false" Height="60"
                                            Width="150" Flex="1" runat="server" ImageUrl="../../../Resources/images/emptysignature.png"/>
                                    </center>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="1" class="style7"></td>
                                <td colspan="2" class="style5">
                                    <strong>(Printed Name and Signature of Customer)<br /></strong><br />
                                </td>
                            </tr>
                        </table>
                    </td>
