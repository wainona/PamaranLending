<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EncashmentView.aspx.cs" Inherits="LendingApplication.Applications.DisbursementUseCases.EncashmentView" %>
         ...
         <TopBar>
          ...
          <Items>
              <ext:Panel ID="pnlEncashmentView" runat="server" Layout="FormLayout" LabelWidth="180" Padding="5"  AutoHeight="true" Title="Disbursement Details">
                        <Items>
                           <ext:Panel ID="Panel2" runat="server" ColumnWidth=".6" Layout="FormLayout" Border="false" Height="210" Width="500">
                                <Items>
                                ...
                                <ext:Hidden ID="hdnSelectedReceiptID" runat="server"></ext:Hidden>
                                    ...
                                    <ext:CompositeField ID="CompositeField1" AnchorHorizontal="95%" runat="server">
                                        <Items>
                                             <ext:TextField ID="txtChkAmount" FieldLabel="Check Amount" runat="server"  ReadOnly="true" Flex="3"></ext:TextField>
                                             <ext:TextField ID="txtCurrency1" runat="server" ReadOnly="true" Flex="1"></ext:TextField>
                                        </Items>
                                    </ext:CompositeField>
                                    ...
                                    <ext:TextField ID="txtSuchargeFee" FieldLabel="Surcharged Fee" runat="server" ReadOnly="true" Hidden="true"  AnchorHorizontal="95%"></ext:TextField>
