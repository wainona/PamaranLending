<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewChange.aspx.cs" Inherits="LendingApplication.Applications.DisbursementUseCases.ViewChange" %>
         ...
         <TopBar>
            <ext:Toolbar ID="Toolbar1" runat="server" Hidden="true">
                <Items>
                    ...
                    <ext:Button ID="btnPrintRelease" runat="server" Text="Print" Icon="PrinterGo" Hidden="true">
                    <Listeners>
                    <Click Handler="printChange();" />
                    </Listeners>
                    </ext:Button>
                </Items>
            </ext:Toolbar>
          ...
          <Items>
              <ext:Panel ID="pnlEncashmentView" runat="server" Layout="FormLayout" LabelWidth="180" Padding="5"  AutoHeight="true" Title="Disbursement Details">
                        <Items>
             <ext:Panel ID="Panel2" runat="server" ColumnWidth=".6" Layout="FormLayout" Border="false" Height="180" Width="400">
                <Items>
                    ...
                    <ext:TextField ID="txtReceiptID" FieldLabel="Receipt Id" runat="server" ReadOnly="true"  AnchorHorizontal="95%"></ext:TextField>
                    <ext:TextField ID="txtReceiptAmount" FieldLabel="Receipt Amount" runat="server" ReadOnly="true"  AnchorHorizontal="95%"></ext:TextField>
                    <ext:TextField ID="txtAmountDisbursed" FieldLabel="Amount Disbursed" runat="server" ReadOnly="true"  AnchorHorizontal="95%"></ext:TextField>
