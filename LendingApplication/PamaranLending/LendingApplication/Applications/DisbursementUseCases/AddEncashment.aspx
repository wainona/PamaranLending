<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEncashment.aspx.cs"
    Inherits="LendingApplication.Applications.DisbursementUseCases.AddEncashment" %>
    ...
    <script type="text/javascript">
        ...
        var saveSuccessful = function () {
            ...
            showAlert('Status', 'Successfully added the record.', function () {
                window.proxy.sendToAll(data, 'addencashment');
            });
        };
        ...
        var onAddCheque = function () {
            ...
            window.proxy.requestNewTab('AddEncashmentCheque', param, 'Add Cheque');
        }
...
<body>
    ...
    <ext:Hidden runat="server" ID="hdnSignatureImage1">
    </ext:Hidden>
    <ext:Viewport ID="PageViewPort" runat="server" Layout="Fit">
        <Items>
            <ext:FormPanel ID="PageFormPanel" runat="server" Border="false" Height="350" AutoScroll="true"
                MonitorValid="true">
                <Defaults>
                                ...
                                <Items>
                                    <ext:Panel ID="Panel2" runat="server" ColumnWidth=".6" Layout="FormLayout" Border="false"
                                        ...
                                        <Items>
                                            ...
                                            <ext:CompositeField AnchorHorizontal="60%" runat="server">
                                                <Items>
                                            ...
                                            <ext:TextField ID="txtDisbursedToName" FieldLabel="Received By" runat="server" AnchorHorizontal="60%">
                                            </ext:TextField>
                                            <ext:CompositeField ID="CompositeField2" runat="server" AnchorHorizontal="60%" Height="85">
                                                <Items>
                                                    <ext:Image ID="imgSpecimenSignature1" Hidden="false" Height="60" Flex="1" runat="server"
                            ...
                            <ext:Panel ID="Panel1" runat="server" Layout="FormLayout" Title="Disbursement Details"
                                ...
                                <Items>
                                    ...
                                    <ext:TextField ID="txtCheckAmount" FieldLabel="Check Amount To Disburse" ReadOnly="true"
                                        runat="server" AnchorHorizontal="45%" Hidden="false">
                                    </ext:TextField>
