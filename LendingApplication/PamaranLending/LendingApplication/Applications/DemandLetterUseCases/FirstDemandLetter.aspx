<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FirstDemandLetter.aspx.cs" Inherits="LendingApplication.Applications.DemandLetterUseCases.FirstDemandLetter" %>
                ...
                <td class="justified" style="vertical-align:bottom;">
                    ...
                    <ext:GridPanel ID="GridPanelInstallmentsDue" runat="server" EnableColumnMove="false" AutoHeight="true" Border="false">
                        ...
                        <ColumnModel ID="ColumnModel1" runat="server">
                            <Columns>
                                <ext:Column Header="Due Dates" DataIndex="_DueDate" Width="364" />
                    ...
                    <br /><br />
                    <p class="justified">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        Again, we are confident that your sense of fair play and good judgment will prompt you to send your payment with in THREE (3) DAYS from receipt of this letter so as to update your account with us.</p>
                    <br />
	                <p class="justified">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        You may be sure that your courtesy will be highly appreciated.</p>
                    <br /><br />
                </td>
            </tr>
            <tr>
                <td class="rightAlign">
                    ...
                    By:<br /><br />
                    <center><ext:TextField ID="txtManagerName" runat="server" Width="230" /></center>
