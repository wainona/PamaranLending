<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageCollateralVehicle.aspx.cs"
    Inherits="LendingApplication.ManageCollateralVehicle" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%@ Register Assembly="Ext.Net" Namespace="Ext.Net" TagPrefix="ext" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="PageHeader" runat="server">
    <title>Manage Jewelry</title>
...
<body>
    ...
    <ext:Store runat="server" ID="storeVehicleType" RemoteSort="false">
        <Reader>
    ...
    <ext:Viewport ID="PageViewPort" runat="server" Layout="Fit">
        <Items>
            <ext:FormPanel ID="PageFormPanel" runat="server" MonitorValid="true" Title="Collateral - Vehicle"
                ...
                <Items>
                    <ext:TextField runat="server" ID="txtCollateralType" ReadOnly="true" Text="Vehicle"
                    ...
                    <ext:ComboBox runat="server" ID="cmbVehicleType" FieldLabel="Vehicle Type" AllowBlank="false"
                        Width="400" Editable="false" TypeAhead="true" Mode="Local" ForceSelection="true"
                        TriggerAction="All" SelectOnFocus="true" ValueField="Id" DisplayField="Name" StoreID="storeVehicleType"/>
                    ...
                    <ext:GridPanel ID="GridPanelPropertyOwners" Title="Property Owner/s" runat="server" Height="290"
