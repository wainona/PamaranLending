<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateLoanApplication.aspx.cs"
    Inherits="LendingApplication.Applications.CreateLoanApplication" %>
...
<head id="PageHeader" runat="server">
    ...
    <script type="text/javascript">
        Ext.onReady(function () {
            ...
            window.proxy.init(['onpickcustomer', 'onpickfinancialproduct', 'addcheque', 'onpickbank', 'onpickinteretrate', 'onpickpastduerate', 'onpickapplicationfee', 'onpickguarantor', 'onpickcoborrower', 'managecollateral', 'addrequireddocument', 'applyloanamortizationchanges']);
            ...
            window.collateral['Jewelry/Others'].tabtitle = 'Manage Jewelry/Others';
        ...
        var onMessageReceived = function (msg) {
            if (msg.tag == 'onpickcustomer') {
                ...
                X.CheckCustomerAgeValidity(msg.data.CustomerID, {
                    success: function (result) {
                        if (result)
                            ...
                            showAlert('Information', 'The age of the customer is below the accepted age limit. Please select another customer.');
                    }
                });
            }
                ...
                //                if (hdnLoanTermIndicator.getValue() == 1)
                //                    btnShowLoanCalculator.enable();
            }
            ...
            else if (msg.tag == 'applyloanamortizationchanges') {
                X.ApplyLoanOptions({
                    success: function () {
                        markIfRequired(nfLoanTerm);
        ...
        var saveSuccessful = function () {
            showAlert('Status', 'Successfully added loan application record.', function () {
                var data = {};
                data.LoanReleaseDate = datLoanReleaseDate.getValue();
                data.PaymentStartDate = datPaymentStartDate.getValue();
                window.proxy.sendToAll(data, 'createLoanApplication');
        ...
        var onBtnEditCollateral = function () {
            var data = SelectionModelCollaterals.getSelected().json;
            var text = window.collateral[data.AssetTypeName];
        ...
        var onbtnEditCheque = function () {
            ...
            if (nfLoanTerm.getValue() != 0) {
                ...
                window.proxy.requestNewTab('ManageCheque', param, 'Cheques');
            }
            else {
        ...
        var onBtnShowLoanCalculator = function () {
            if (hiddenProductId.getValue()) {
                ...
                var param = url + "?ResourceGuid=" + hiddenResourceGuid.getValue();
                param = param + "&termIndicator=" + hdnLoanTermIndicator.getValue();
        ...
        var CheckCreditLimit = function () {
            X.CheckCreditLimit({
                success: function (result) {
                    if (result) {
                        showConfirm('Confirm', 'Loan Amount is greater than Credit Limit and the allowed numbers of straight line/diminishing balance loan per customer is already reached. Do you want to continue creating this loan application record?', function (btn) {
                            if (btn == 'no') {
                                return false;
                            } else {
                                btnSaveActual.fireEvent('click');
        ...
        var OnChkTermChanged = function () {
            if (chckWithTerm.getValue() == true) {
                ...
                markIfRequired(nfLoanTerm);
                markIfRequired(cmbPaymentMode);
//                if (txtLoanProductName.getValue() != '')
//                    btnShowLoanCalculator.enable();
            }
...
//                                btnShowLoanCalculator.disable();
        ...
        var resetCheque = function () {
            ...
            var selectedRowIndex = SelectionModelCheque.last;
            grdpnlCheque.getView().focusRow(selectedRowIndex);
        }
...
<body>
    ...
    <ext:ResourceManager ID="PageResourceManager" runat="server" DirectMethodNamespace="X"
        IDMode="Explicit" />
    <ext:Hidden ID="hdnLoanTermIndicator" runat="server"></ext:Hidden>
    ...
    <ext:Hidden runat="server" ID="hdnChequeBankId"></ext:Hidden>
    <ext:Hidden runat="server" ID="hdnTermOption"></ext:Hidden>
    <ext:Hidden runat="server" ID="hdnTermOptionId" Text="-1"></ext:Hidden>
    <ext:Hidden runat="server" ID="hdnOnChangeDates"></ext:Hidden>
            ...
            <ext:FormPanel ID="RootPanel" runat="server" Layout="FitLayout" Border="false" MonitorValid="true" MonitorPoll="500">
                ...
                <Items>
                    <ext:TabPanel ID="PageTabPanel" runat="server" EnableTabScroll="true" Padding="0"
                        ...
                        <Items>
                            <ext:Panel runat="server" Title="Borrowers Information" Border="false" Padding="5" AutoScroll="true">
                                <Items>
                                    <ext:Panel runat="server" ID="PanelBorrowerBasicInformation" Title="Basic Information"
                                        Padding="5" Width="800" Layout="Column" RowHeight="0.5" Height="260">
                                        <Items>
                                            ...
                                            <ext:Panel runat="server" LabelWidth="120" Layout="FormLayout" Border="false" ColumnWidth=".6">
                                                <Items>
                                                    ...
                                                    <ext:TextField ID="txtCustomerName" AllowBlank="false" runat="server" FieldLabel="Name" ReadOnly="true"
                                    ...
                                    <ext:Panel runat="server" ID="PanelBorrowerContactInformation" Title="Contact Information"
                                        Padding="5" Width="800" Layout="Form" LabelWidth="200" RowHeight="0.5">
                                        <Items>
                                            ...
                                            <ext:CompositeField ID="cmpCellphoneNumber" DataIndex="" runat="server" Width="500">
                                                <Items>
                                                    <ext:TextField ID="txtCellNumberCountryCode" runat="server" Width="150" ReadOnly="true" FieldLabel="Cellphone Number">
                                                    </ext:TextField>
                                                    ...
                                                    <ext:TextField ID="nfCellNumberPhoneNumber" runat="server" Width="150" ReadOnly="true">
                                                    </ext:TextField>
                                                </Items>
                                            </ext:CompositeField>
                            ...
                            <ext:Panel runat="server" ID="PanelLoanApplicationDetails" Title="Loan Application Details"
                                ...
                                <Items>
                                    ...
                                    <ext:CompositeField ID="cfFinancialProduct" DataIndex="" runat="server" Width="500">
                                        <Items>
                                            <ext:TextField ID="txtLoanProductName" FieldLabel="Loan Product Name" runat="server" ReadOnly="true" Width="400" AllowBlank="false"/>
                                    ...
                                    <ext:DateField ID="datLoanReleaseDate" runat="server" FieldLabel="Loan Release Date"
                                        Width="400" ReadOnly="false" Editable="false" AllowBlank="false" Vtype="daterange">
                                        <Listeners>
                                            <Select Handler="adjustPaymentStartDate();" />
                                        </Listeners>
                                    </ext:DateField>
                                    <ext:DateField ID="datPaymentStartDate" runat="server" FieldLabel="Payment Start Date"
                                                                    Width="400" Editable="false" AllowBlank="false" LabelWidth="100" Vtype="daterange" StartField="datLoanReleaseDate"/>
                                    <ext:TextField ID="nfLoanAmount" runat="server" FieldLabel="Loan Amount"
                                        ...
                                        <Listeners>
                                            ...
                                            <Blur Handler="checkLoanAmountLimit();" />
                                        </Listeners>
                                    </ext:TextField>
                                    <%--<ext:CompositeField ID="cfLoanCalculator" DataIndex="" runat="server" Width="500" Hidden="true">
                                        <Items>
                                            <ext:TextField ID="TextField1" runat="server" FieldLabel="Loan Amount"
                                                Width="400" AllowBlank="false" MaskRe="[0-9\.\,]" Hidden="true">
                                                <Listeners>
                                                    <Change Handler="var value = this.getValue().replace(/,/g,'');value = value.replace(/[]/g, '');this.setValue(Ext.util.Format.number(value, '0,0.00'));checkLoanAmountLimit();" />
                                                    <Blur Handler="checkLoanAmountLimit();" />
                                                </Listeners>
                                            </ext:TextField>
                                            <ext:Button ID="btnShowLoanCalculator" runat="server" Hidden="true" Text="Loan Calculator" Disabled="true">
                                                <DirectEvents>
                                                    <Click OnEvent="btnApplyLoanOption_Click" Success="onBtnShowLoanCalculator();">
                                                        <EventMask ShowMask="true" Msg="Applying changes and showing loan calculator..." />
                                                    </Click>
                                                </DirectEvents>
                                            </ext:Button>
                                        </Items>
                                    ...
                                    <%--<ext:RadioGroup ID="rdoLoanTerm" runat="server" FieldLabel="Is the loan with term?"
                                        ...
                                        <Items>
                                            ...
                                            <ext:Radio runat="server" ID="chckWithoutTerm" BoxLabel="No" Checked="true">
                                                <Listeners>
                                                    <Check Handler="OnChkTermChanged();" />
                                                </Listeners>
                                            </ext:Radio>
                                    ...
                                    <ext:NumberField ID="nfLoanTerm" runat="server" FieldLabel="Loan Term" Number="0"
                                        Width="400" ReadOnly="false" Disabled="true"/>
                                    ...
                                    <ext:ComboBox runat="server" ID="cmbPaymentMode" FieldLabel="Payment Mode" Width="400"
                                        ...
                                        SelectOnFocus="true" AllowBlank="true" StoreID="storePaymentMethod" ValueField="Id"
                                        DisplayField="Name"  ReadOnly="false" Disabled="true" SelectedIndex="3"/>
                                    ...
                                    <ext:Panel runat="server" ID="PanelInterestRate" Title="Interest Rate" LabelWidth="180"
                                        ...
                                        <Items>
                                            ...
                                            <ext:Panel ID="Panel2" runat="server" Border="false" Header="false" ColumnWidth=".15"
                                                Padding="2">
                                                <Items>
                            ...
                            <ext:Panel runat="server" ID="panelOutstandingLoans" Title="Outstanding Loans"
                                Border="false" LabelWidth="400" Layout="FitLayout" AutoScroll="true">
                                <TopBar>
                                    <ext:Toolbar runat="server" Hidden="true">
                                        <Items>
                                           <ext:Checkbox ID="chkPayOutstandingLoan" runat="server" FieldLabel="Pay the following outstanding loan/s using the proceeds of the new loan">
                                            <Listeners>
                                ...
                                <Items>
                                    <%--<ext:GridPanel ID="panelPayOutstandingLoan" runat="server" Title="Outstanding Loan/s to Pay Off">--%>
                                    <ext:GridPanel ID="panelPayOutstandingLoan" runat="server" Title="Outstanding Loan/s">
                                        <View>
                                        ...
                                        <ColumnModel runat="server" ID="clmModelPayOutstandingLoan" Width="100%" >
                                            <Columns>
                                                ...
                                                <ext:Column Header="Interest Computation Mode" DataIndex="InterestComputationMode"
                                                    Locked="true" Wrap="true" Width="190" />
                                                <ext:Column Header="Maturity Date" DataIndex="MaturityDate" Locked="true" Wrap="true"
                                                    Width="120" />
                            ...
                            <ext:Panel runat="server" ID="PanelFeeAndCoBorrower" Title="Fees and Co-Borrowers"
                                Border="false" Layout="RowLayout">
                                <Items>
                                    <ext:GridPanel ID="GridPanelFee" Title="Fees" runat="server" RowHeight=".5" AutoExpandColumn="Name" AutoScroll="true">
                                        <View>
                            ...
                            <ext:Panel runat="server" ID="PanelGuarantorAndCollaterals" Title="Guarantors, Collaterals and Submitted Documents"
                                Border="false" Layout="RowLayout">
                                <Items>
                                    <ext:Panel ID="Panel8" runat="server"  Title="Guarantors">
                                        <Items>
                                            ...
                                            <ext:GridPanel ID="GridPanelGuarantors" runat="server"
                                                AutoExpandColumn="Address" AutoScroll="true" Height="115">
                                                <View>
                                                    <ext:GridView ID="GridView3" EmptyText="No guarantors to display" runat="server" DeferEmptyText="false"></ext:GridView>
                                                </View>
                                                <Store>
                                    ...
                                    <ext:Panel ID="Panel7" runat="server" Title="Collaterals">
                                        <Items>
                                            <ext:Toolbar ID="ToolbarCollateral" runat="server">
                                                <Items>
                                                    <ext:Button ID="btnDeleteCollateral" runat="server" Text="Delete" Icon="Delete" Disabled="true">
                                                        <DirectEvents>
                                                            <Click OnEvent="btnDeleteCollateral_Click"></Click>
                                                        </DirectEvents>
                                                    </ext:Button>
                                                    <ext:ToolbarSeparator>
                                                    </ext:ToolbarSeparator>
                                            ...
                                            <ext:GridPanel ID="GridPanelCollaterals" runat="server"
                                                AutoExpandColumn="Description" Height="118" AutoScroll="true">
                                                <View>
                                                    <ext:GridView ID="GridView4" EmptyText="No collaterals to display" runat="server" DeferEmptyText="false"></ext:GridView>
                                                </View>
                                                <Store>
                                    ...
                                    <ext:Panel ID="Panel9" runat="server" Title="Submitted Documents">
                                        <Items>
                                            ...
                                            <ext:GridPanel ID="GridPanelSubmittedDocuments" runat="server"
                                                AutoExpandColumn="DocumentDescription" Height="116" AutoScroll="true">
                                                <View>
                                                    <ext:GridView ID="GridView5" EmptyText="No documents to display" runat="server" DeferEmptyText="false"></ext:GridView>
                                                </View>
                                                <SelectionModel>
                                                        ...
                                                        <Reader>
                                                            <ext:JsonReader runat="server" IDProperty="RandomKey">
                                                                <Fields>
                                                                    ...
                                                                    <ext:RecordField Name="DateSubmitted" Type="Date"/>
                                                ...
                                                <ColumnModel>
                                                    <Columns>
                                                        ...
                                                        <ext:DateColumn runat="server" Header="Date Submitted" DataIndex="DateSubmitted" Width="188">
                                                        </ext:DateColumn>
                            ...
                            <ext:Panel runat="server" ID="PanelCheque" Title="Schedule and Cheques"
                                ...
                                <Items>
                                    <ext:RowLayout runat="server" Split="true" FitHeight="true">
                                        <Rows>
                                            <ext:LayoutRow runat="server" RowHeight="0.55">
                                                <ext:GridPanel runat="server" ID="grdPnlAmortizationSchedule" Title="Amortization Schedule" AutoScroll="true" Layout="FitLayout" AutoExpandColumn="TotalPayment">
                                                    <View>
                                                    ...
                                                    <TopBar>
                                                        <ext:Toolbar ID="Toolbar2" runat="server">
                                                            <Items>
                                                                <ext:ToolbarSpacer />
                                                                <ext:ToolbarSpacer />
                                                                <ext:Checkbox ID="chckCheck" runat="server" LabelWidth="130" FieldLabel="Add Post Dated Checks">
                                                                </ext:Checkbox> 
                                                                ...
                                                                <ext:ToolbarSeparator />
                                                                <ext:ToolbarSpacer />
                                                                <ext:Button ID="btnPrintSchedule" runat="server" Text="Print Temporary Schedule" Icon="Printer">
                                                                    <Listeners>
                                            ...
                                            <ext:LayoutRow runat="server" RowHeight="0.44">
                                                <ext:GridPanel ID="grdpnlCheque" runat="server" AutoExpandColumn="BankName"
                                                    Height="250" AutoScroll="true" Title="Associated Checks">
                                                    <View>
                                                        <ext:GridView ID="GridView2" EmptyText="No cheques to display" runat="server" DeferEmptyText="false"></ext:GridView>
                                                    </View>
                                                    <Store>
    ...
    <%--Add Cheque--%>
    <ext:Window runat="server" ID="wdwCheque" Collapsible="true" Height="240" Icon="Application"
        Title="Add Cheque" Width="500" Hidden="true" Modal="true" Resizable="false" AutoFocus="true">
        <Items>
            <ext:FormPanel ID="fpNewFee" runat="server" Padding="5" LabelWidth="190" Layout="FitLayout"
                ...
                <Items>
                    ...
                    <ext:Checkbox ID="chckBank" runat="server" FieldLabel="Use this bank for all cheques?" Checked="false">
                        <Listeners>
