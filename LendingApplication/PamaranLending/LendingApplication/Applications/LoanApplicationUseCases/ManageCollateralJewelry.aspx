<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageCollateralJewelry.aspx.cs"
    Inherits="LendingApplication.ManageCollateralJewelry" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%@ Register Assembly="Ext.Net" Namespace="Ext.Net" TagPrefix="ext" %>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="PageHeader" runat="server">
    <title>Manage Jewelry/Others</title>
...
<body>
    ...
    <ext:Viewport ID="PageViewPort" runat="server" Layout="Fit">
        <Items>
            <ext:FormPanel ID="PageFormPanel" runat="server" MonitorValid="true" Title="Collateral - Jewelry/Others"
                ...
                <Items>
                    <%--<ext:TextField runat="server" ID="txtCollateralType" ReadOnly="true" Text="Jewelry"
                        FieldLabel="Collateral Type" Width="400" />--%>
                    <ext:ComboBox runat="server" ID="cmbCollateralType" ReadOnly="false" FieldLabel="Collateral Type"
                        Width="400" Editable="false" AllowBlank="false">
                        <Items>
                            <ext:ListItem Text="Jewelry" Value="0"/>
                            <ext:ListItem Text="Others" Value="1" />
                        </Items>    
                    </ext:ComboBox>
                    ...
                    <ext:GridPanel ID="GridPanelPropertyOwners" Title="Property Owner/s" runat="server" Height="370"
