<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PickListCoBorrower.aspx.cs"
    Inherits="LendingApplication.Applications.LoanApplicationUseCases.PickListCoBorrower" %>
    ...
    <script type="text/javascript">
        ...
        var btnSelectClick = function () {
            if (PageGridPanelSelectionModel.singleSelect) {
                ...
                window.proxy.sendToParent(data.json, 'onpickcoborrower');
            }
            else {
                var selectedValues = [];
                ...
                window.proxy.sendToParent(selectedValues, 'onpickcoborrowers');
            }
            window.proxy.requestClose();
        }
...
<body>
    ...
    <ext:Viewport ID="PageViewPort" runat="server" Layout="Fit">
        <Items>
            ...
            <View>
                <ext:GridView runat="server" EmptyText="No allowed co-borrowers to display" DeferEmptyText="false"></ext:GridView>
            </View>
