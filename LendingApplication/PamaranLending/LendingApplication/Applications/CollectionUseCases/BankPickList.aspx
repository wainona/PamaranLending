<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankPickList.aspx.cs" Inherits="LendingApplication.Applications.CollectionUseCases.BankPickList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        Ext.onReady(function () {
            ...
            window.proxy.init(['addbank', 'updatebank']);
            ...
            <ext:GridPanel ID="PageGridPanel" runat="server" AutoExpandColumn="Address">
                <TopBar>
                    <ext:Toolbar ID="PageGridPanelToolbar" runat="server">
                        <Items>
                            <ext:Button ID="btnSelect" runat="server" Text="Select" Icon="ApplicationGet" Disabled="true">
                                <Listeners>
                            ...
                            <ext:ToolbarFill />
                            <ext:ComboBox ID="cmbSearch" runat="server" EmptyText="Search by...">
                                <Items>
