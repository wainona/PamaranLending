<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GenerateAmortizationSchedule.aspx.cs"
    Inherits="LendingApplication.Applications.LoanRestructureUseCases.GenerateAmortizationSchedule" %>
                ...
                <TopBar>
                    <ext:Toolbar runat="server" ID="RootToolBar">
                        <Items>
                            ...
                            <ext:Button runat="server" Hidden="true" ID="btnClose" Text="Close" Icon="Cancel" />
                        </Items>
                    </ext:Toolbar>
                </TopBar>
                <Items>
                    <ext:Panel runat="server" ID="PanelGenerateAmortizationSchedule"
                        Padding="0" Layout="FitLayout" LabelWidth="180">
                        <Items>
                            <ext:Panel runat="server" Layout="FitLayout" LabelWidth="420" Border="false">
                                <Items>
