<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCheque.aspx.cs" Inherits="LendingApplication.Applications.LoanRestructureUseCases.AddCheque" %>
...
<head id="PageHeader" runat="server">
    ...
    <script type="text/javascript">
        ...
        var saveSuccessful = function () {
            ...
            data.RandomKey = hdnRandomKey.getValue();
        ...
        var validateCheckNumber = function () {
            ...
            var rKey = hdnRandomKey.getValue();
            X.ValidateCheckNumber(checkNumber, rKey, {
...
<body>
    ...
    <ext:Hidden runat="server" ID="hdnIndex"></ext:Hidden>
    <ext:Hidden runat="server" ID="hdnRandomKey"></ext:Hidden>
    <ext:Hidden runat="server" ID="hdnChequeValid"/>
    <ext:Hidden runat="server" ID="hdnChequeType"/>
    <ext:Viewport ID="PageViewPort" runat="server" Layout="Fit">
        ...
        <ext:FormPanel ID="PageFormPanel" runat="server" Padding="5" MonitorValid="true" MonitorPoll="500" BodyStyle="background-color:transparent" 
                    Layout="FormLayout" LabelWidth="250">
            <Defaults>
            ...
            <TopBar>
              <ext:ToolBar ID="ToolBar1" runat="server">
                  <Items>
                      <ext:Button ID="btnSave" runat="server" Text="Add" Icon="Disk">
                        <%--<DirectEvents>
            ...
            <Items>
                <%--Transaction Date--%>
                <ext:DateField ID="dtTransactionDate" ReadOnly="true" runat="server" FieldLabel="Transaction Date" Width="400" Editable="false" AllowBlank="false"/><%--Transaction Date--%>
                <%--Amount--%>
                <ext:TextField ID="txtAmount" runat="server" ReadOnly="true" FieldLabel="Amount (Php)" Width="400" AllowBlank="false" MaskRe="[0-9\.\,]">
                    <Listeners>
                ...
                <%--Cheque Status--%>
                <ext:TextField runat="server" ID="txtChequeStatus" FieldLabel="Check Status" Width="400" ReadOnly="true" AllowBlank="false"></ext:TextField>
                <%--Cheque Remarks--%>
                <ext:TextArea ID="txtaCheckRemarks" runat="server" FieldLabel="Remarks" Width="400" AllowBlank="true"/>
                <%--Cheque Date--%>
                <ext:DateField ID="dtCheckDate" ReadOnly="true" runat="server" FieldLabel="Check Date" Width="400" Editable="false" AllowBlank="false"/>
            </Items>
            <BottomBar>
