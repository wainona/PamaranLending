<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PickListInterestRate.aspx.cs" Inherits="LendingApplication.PickListInterestRate" %>
    ...
    <script type="text/javascript">
        ...
        var btnSelectClick = function () {
            if (PageGridPanelSelectionModel.singleSelect) {
                ...
                window.proxy.sendToParent(data.json, 'onpickinteretrate');
            }
            else {
                var selectedValues = [];
                ...
                window.proxy.sendToParent(selectedValues, 'onpickinteretrates');
            }
    ...
    <ext:Viewport ID="PageViewPort" runat="server" Layout="Fit">
        <Items>
            <ext:GridPanel 
                ...
                Layout="Fit">
                <View>
                    <ext:GridView runat="server" EmptyText="No interest rates to display" DeferEmptyText="false"></ext:GridView>
                </View>
                        ...
                        <Reader>
                            <ext:JsonReader IDProperty="ProductFeatureApplicabilityId">
                                <Fields>
                                    ...
                                    <ext:RecordField Name="FeatureID" />
