<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PickListRequiredDocumentType.aspx.cs" Inherits="LendingApplication.BestPractice.PickListRequiredDocumentType" %>
    ...
    <script type="text/javascript">
        ...
        var btnSelectClick = function () {
            if (PageGridPanelSelectionModel.singleSelect) {
                ...
                window.proxy.sendToParent(data.json, 'onpickrequireddocumenttype');
            }
            else {
                var selectedValues = [];
                ...
                window.proxy.sendToParent(selectedValues, 'onpickrequireddocumenttypes');
            }
    ...
    <ext:Viewport ID="PageViewPort" runat="server" Layout="Fit">
        <Items>
            <ext:GridPanel 
                ...
                Layout="Fit">
                <View>
                    <ext:GridView runat="server" EmptyText="No required documents to display" DeferEmptyText="false"></ext:GridView>
                </View>
