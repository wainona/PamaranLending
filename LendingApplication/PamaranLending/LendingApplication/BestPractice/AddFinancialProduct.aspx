<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddFinancialProduct.aspx.cs"
    Inherits="LendingApplication.AddFinancialProduct" %>
    ...
    <script type="text/javascript">
        ...
        var onMessageReceived = function (msg) {
            ...
            if (msg.tag == 'onpickrequireddocumenttype') {
                //                var document = {};
                //                document.DocumentId = msg.data.ID;
                //                document.DocumentTypeName = msg.data.Name;
                //                gridRequiredDocumentType.addRecord(document);
        ...
        var saveSuccessful = function () {
            showAlert('Status', 'Successfully added the financial product record.', function () {
                window.proxy.sendToAll('addfinancialproduct', 'addfinancialproduct');
        ...
        var onFormValidated = function (valid) {
            ...
            if (valid && GridPanelInterestRate.store.getCount() > 0) {
                ...
                PageFormPanelStatusBar.setStatus({ text: 'Please add interest rates.', iconCls: 'icon-exclamation' });
            }
            else {
...
<body>
                    ...
                    <ext:TabPanel ID="PageTabPanel" runat="server" EnableTabScroll="true" Padding="0"
                        ...
                        <Items>
                                            ...
                                            <ext:Panel ID="fsLoanTerm" Title="Loan Term" runat="server" Height="120" ColumnWidth=".5"
                                                ...
                                                <Items>
                                                    <ext:NumberField ID="nfMinimumLoanTerm" FieldLabel="Minimum Loan Term" runat="server"
                                                        AllowBlank="false" MsgTarget="Side"  DecimalPrecision="0" AnchorHorizontal="95%"
                                                        Vtype="numberrange" EndNumberField="#{nfMaximumLoanTerm}" />
                                                    <ext:NumberField ID="nfMaximumLoanTerm" FieldLabel="Maximum Loan Term" runat="server"
                                                        AllowBlank="false" MsgTarget="Side"  DecimalPrecision="0" AnchorHorizontal="95%"
                                                        Vtype="numberrange" StartNumberField="#{nfMinimumLoanTerm}"/>
                                    ...
                                    <ext:GridPanel ID="gridPanelFee" runat="server">
                                            ...
                                            <ext:Toolbar ID="tbFee" runat="server">
                                                <Items>
                                                    <ext:Button ID="btnDeleteFee" runat="server" Text="Delete" Icon="Delete" Disabled="true">
                                                        <DirectEvents>
                                                            <Click OnEvent="btnDeleteFee_Click" Success="#{btnDeleteFee}.disable();">
                                                            </Click>
                                                        </DirectEvents>
                                                    </ext:Button>
                                                    <ext:ToolbarSeparator>
                                        ...
                                        <ColumnModel>
                                            <Columns>
                                                ...
                                                <ext:NumberColumn runat="server" Header="Charge Amount" DataIndex="ChargeAmount"
                                                    Width="250" Format=",000.00">
                                                </ext:NumberColumn>
                                                <ext:NumberColumn runat="server" Header="Base Amount" DataIndex="BaseAmount" Width="250"
                                                    Format=",000.00">
                                                </ext:NumberColumn>
                            ...
                            <ext:Panel runat="server" ID="RequiredDocumentTypeView" Title="Required Document Type View"
                                Layout="FitLayout">
                                <Items>
                                    <ext:GridPanel ID="gridRequiredDocumentType" runat="server" AutoExpandColumn="Name">
                                        <Items>
                                        ...
                                        <ColumnModel>
                                            <Columns>
                                                <ext:Column runat="server" Header="Document Name" DataIndex="Name" Width="250">
                                                </ext:Column>
                                            </Columns>
                                        </ColumnModel>
                                    </ext:GridPanel>
    ...
    <ext:Window ID="newInterestRate" runat="server" Collapsible="true" Height="125" Icon="Application"
    ...
    <ext:Window ID="newPastDueInterestRate" runat="server" Collapsible="true" Height="125"
