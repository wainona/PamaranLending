<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PickListFees.aspx.cs" Inherits="LendingApplication.PickListFees" %>
    ...
    <script type="text/javascript">
        ...
        var btnSelectClick = function () {
            if (PageGridPanelSelectionModel.singleSelect) {
                ...
                window.proxy.sendToParent(data.json, 'onpickfee');
            }
            else {
                var selectedValues = [];
                ...
                window.proxy.sendToParent(selectedValues, 'onpickfees');
            }
...
<body>
    ...
    <ext:Viewport ID="PageViewPort" runat="server" Layout="Fit">
        <Items>
            ...
            <View>
                <ext:GridView runat="server" EmptyText="No fees to display" DeferEmptyText="false"></ext:GridView>
            </View>
            <LoadMask ShowMask="true" />
                ...
                <Store>
                    <ext:Store ID="storeFees" runat="server">
                        <Reader>
                ...
                <ColumnModel>
                    <Columns>
                        ...
                        <ext:NumberColumn runat="server" Header="Charge Amount" DataIndex="ChargeAmount" Width="250" Format=",000.00">
                        </ext:NumberColumn>
                        <ext:NumberColumn runat="server" Header="Base Amount" DataIndex="BaseAmount" Width="250" Format=",000.00">
                        </ext:NumberColumn>
