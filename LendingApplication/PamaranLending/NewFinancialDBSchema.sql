...
INSERT [dbo].[ProductFeatureApplicability] ([Id], [FinancialProductId], [ProductFeatureId], [EffectiveDate], [EndDate], [Value]) VALUES (6, 1, 1, CAST(0x00009F8301264C25 AS DateTime), NULL, NULL)
...
INSERT [dbo].[ProductFeatureApplicability] ([Id], [FinancialProductId], [ProductFeatureId], [EffectiveDate], [EndDate], [Value]) VALUES (8, 1, 8, CAST(0x00009F8301264C25 AS DateTime), NULL, NULL)
...
INSERT [dbo].[ProductFeatureApplicability] ([Id], [FinancialProductId], [ProductFeatureId], [EffectiveDate], [EndDate], [Value]) VALUES (11, 1, 10, CAST(0x00009F8301264C25 AS DateTime), NULL, NULL)
INSERT [dbo].[ProductFeatureApplicability] ([Id], [FinancialProductId], [ProductFeatureId], [EffectiveDate], [EndDate], [Value]) VALUES (12, 1, 4, CAST(0x00009F8301264C25 AS DateTime), NULL, CAST(1000.00 AS Numeric(18, 2)))
...
CREATE TABLE [dbo].[ForeignExchange](
	...
	[ReceivedCurrencyId] [int] NOT NULL,
	[AmountReleased] [decimal](18, 4) NOT NULL,
	[ReleasedCurrencyId] [int] NOT NULL,
	[EntryDate] [datetime] NOT NULL,
	[TransactionDate] [datetime] NOT NULL,
	[IsSpot] [bit] NOT NULL,
